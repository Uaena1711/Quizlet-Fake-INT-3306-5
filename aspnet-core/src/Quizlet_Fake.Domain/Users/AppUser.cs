...
namespace Quizlet_Fake.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update Quizlet_FakeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update Quizlet_FakeEfCoreEntityExtensionMappings to extend the IdentityUser entity
